...
// Type: Gbs.Helpers.ФайлДокументСвПродПерСвПерТранГрузТранНакл
...
namespace Gbs.Helpers
{
  ...
  [Serializable]
  public class ФайлДокументСвПродПерСвПерТранГрузТранНакл
  {
