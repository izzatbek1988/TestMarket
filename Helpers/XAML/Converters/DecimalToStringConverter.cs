...
// Type: Gbs.Helpers.XAML.Converters.DecimalToStringConverter
...
namespace Gbs.Helpers.XAML.Converters
{
  public class DecimalToStringConverter : IValueConverter
  {
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
      ...
      string format = "N";
      if (new ConfigsRepository<Settings>().Get().Interface.IsHideExtraZeros && num1 == 0M || num1 != 0M)
      {
        if (num2 > 0 && num1 != 0M)
        {
          int num3 = num2 > 3 ? 3 : num2;
