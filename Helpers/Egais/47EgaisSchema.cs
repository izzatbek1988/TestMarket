...
// Type: Gbs.Helpers.Egais.InvoiceExportFSMTypeHeader
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/InvoiceExportFSM")]
  [Serializable]
  public class InvoiceExportFSMTypeHeader
  {
