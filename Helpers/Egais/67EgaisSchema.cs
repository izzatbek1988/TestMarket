...
// Type: Gbs.Helpers.Egais.WineMaterialType
...
namespace Gbs.Helpers.Egais
{
  ...
  public class WineMaterialType
  {
    ...
    private Decimal volumeEstimatedRestField;
    private bool volumeEstimatedRestFieldSpecified;
    ...
    public Decimal VolumeEstimatedRest
    {
      get => this.volumeEstimatedRestField;
      set => this.volumeEstimatedRestField = value;
    }

    [XmlIgnore]
    public bool VolumeEstimatedRestSpecified
    {
      get => this.volumeEstimatedRestFieldSpecified;
      set => this.volumeEstimatedRestFieldSpecified = value;
    }
