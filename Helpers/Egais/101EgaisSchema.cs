...
// Type: Gbs.Helpers.Egais.TransportType3
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(TypeName = "TransportType", Namespace = "http://fsrar.ru/WEGAIS/TTNSingle_v4")]
  [Serializable]
  public class TransportType3
  {
    private WbChangeOwnershipType changeOwnershipField;
    private string tRAN_TYPEField;
    private string tRAN_COMPANYField;
    private WbCTransportType tRANSPORT_TYPEField;
    private string tRANSPORT_REGNUMBERField;
    ...
    public WbChangeOwnershipType ChangeOwnership
    {
      get => this.changeOwnershipField;
      set => this.changeOwnershipField = value;
    }
    ...
    public WbCTransportType TRANSPORT_TYPE
    {
      get => this.tRANSPORT_TYPEField;
      set => this.tRANSPORT_TYPEField = value;
    }

    public string TRANSPORT_REGNUMBER
    {
      get => this.tRANSPORT_REGNUMBERField;
      set => this.tRANSPORT_REGNUMBERField = value;
    }
