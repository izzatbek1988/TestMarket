...
// Type: Gbs.Helpers.Egais.WayBillType_v4Header
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/TTNSingle_v4")]
  [Serializable]
  public class WayBillType_v4Header
  {
    private WbType4 typeField;
    ...
    public WayBillType_v4Header() => this.typeField = WbType4.WBInvoiceFromMe;
