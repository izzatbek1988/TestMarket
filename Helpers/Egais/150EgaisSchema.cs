...
// Type: Gbs.Helpers.Egais.RepProducedType_v4Header
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/RepProducedProduct_v4")]
  [Serializable]
  public class RepProducedType_v4Header
  {
    private OperType2 typeField;
    ...
    public RepProducedType_v4Header() => this.typeField = OperType2.OperProduction;

    public OperType2 Type
    {
      get => this.typeField;
