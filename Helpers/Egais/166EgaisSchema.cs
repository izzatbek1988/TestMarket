...
// Type: Gbs.Helpers.Egais.CarrierNotice
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(Namespace = "http://fsrar.ru/WEGAIS/CarrierNotice")]
  [Serializable]
  public class CarrierNotice
  {
    private CarrierNoticeHeader headerField;
    private PositionType10[] contentField;
