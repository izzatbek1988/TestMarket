...
// Type: Gbs.Helpers.Egais.TTNShipmentFSMTypeHeader
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/TTNShipmentFSM")]
  [Serializable]
  public class TTNShipmentFSMTypeHeader
  {
