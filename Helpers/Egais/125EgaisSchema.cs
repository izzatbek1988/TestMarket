...
// Type: Gbs.Helpers.Egais.RequestRepealEAM
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(Namespace = "http://fsrar.ru/WEGAIS/RequestRepealEAM")]
  [Serializable]
  public class RequestRepealEAM
  {
    ...
    public string EAMRegId
    {
      get => this.eAMRegIdField;
      set => this.eAMRegIdField = value;
    }
  }
}
