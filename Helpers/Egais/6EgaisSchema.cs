...
// Type: Gbs.Helpers.Egais.RepImportedType_v4Header
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct_v4")]
  [Serializable]
  public class RepImportedType_v4Header
  {
    ...
    private string iDInvoicePlannedImportField;
    ...
    public string IDInvoicePlannedImport
    {
      get => this.iDInvoicePlannedImportField;
      set => this.iDInvoicePlannedImportField = value;
    }
  }
}
