...
// Type: Gbs.Helpers.Egais.ManufacturingNoticeFSMHeader
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/ManufacturingNoticeFSM")]
  [Serializable]
  public class ManufacturingNoticeFSMHeader
  {
    private string noticeNumberField;
    private DateTime noticeDateField;
    private string decisionNumberField;
    private DateTime decisionDateField;
    ...
    {
      get => this.noticeNumberField;
      set => this.noticeNumberField = value;
    }

    [XmlElement(DataType = "date")]
    public DateTime NoticeDate
    {
      get => this.noticeDateField;
      set => this.noticeDateField = value;
    }

    public string DecisionNumber
    {
      get => this.decisionNumberField;
      set => this.decisionNumberField = value;
    }

    [XmlElement(DataType = "date")]
    public DateTime DecisionDate
    {
      get => this.decisionDateField;
      set => this.decisionDateField = value;
    }
