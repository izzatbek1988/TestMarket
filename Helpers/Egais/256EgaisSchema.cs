...
// Type: Gbs.Helpers.Egais.TransferToShopTypeHeader
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/TransferToShop")]
  [Serializable]
  public class TransferToShopTypeHeader
  {
