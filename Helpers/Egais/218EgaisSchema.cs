...
// Type: Gbs.Helpers.Egais.ReplyRests_Mini
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(Namespace = "http://fsrar.ru/WEGAIS/ReplyRests_Mini")]
  [Serializable]
  public class ReplyRests_Mini
  {
    private DateTime restsDateField;
    private StockPositionType2[] productsField;
    ...
    public StockPositionType2[] Products
    {
