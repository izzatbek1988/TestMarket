...
// Type: Gbs.Helpers.Egais.WayBillInformBRegTypeHeader
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/TTNInformBReg")]
  [Serializable]
  public class WayBillInformBRegTypeHeader
  {
