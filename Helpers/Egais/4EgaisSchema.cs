...
// Type: Gbs.Helpers.Egais.PositionType17
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(TypeName = "PositionType", Namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct_v4")]
  [Serializable]
  public class PositionType17
  {
    ...
    private string plannedImportField;
    ...
    public string PlannedImport
    {
      get => this.plannedImportField;
      set => this.plannedImportField = value;
    }
