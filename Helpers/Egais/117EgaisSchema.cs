...
// Type: Gbs.Helpers.Egais.WayBillActType_v4Header
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/ActTTNSingle_v4")]
  [Serializable]
  public class WayBillActType_v4Header
  {
    private AcceptType3 isAcceptField;
    private string aCTNUMBERField;
    private DateTime actDateField;
    private string wBRegIdField;
    private string noteField;

    public AcceptType3 IsAccept
    {
