...
// Type: Gbs.Helpers.Egais.RepProducedType_v3Header
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/RepProducedProduct_v3")]
  [Serializable]
  public class RepProducedType_v3Header
  {
    private OperType1 typeField;
    ...
    public RepProducedType_v3Header() => this.typeField = OperType1.OperProduction;

    public OperType1 Type
    {
      get => this.typeField;
