...
// Type: Gbs.Helpers.Egais.WayBillActType_v2Header
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/ActTTNSingle_v2")]
  [Serializable]
  public class WayBillActType_v2Header
  {
