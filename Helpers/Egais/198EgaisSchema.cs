...
// Type: Gbs.Helpers.Egais.ActWriteOffType_v3Header
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/ActWriteOff_v3")]
  [Serializable]
  public class ActWriteOffType_v3Header
  {
