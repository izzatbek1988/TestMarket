...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(Namespace = "http://fsrar.ru/WEGAIS/Route")]
  [Serializable]
  public class Route
  {
    private string nUMBERField;
    private DateTime dateField;
    private RouteOwnership ownershipField;
    private string wBRegIdField;
    private string[] parentRoutesField;
    private RouteTRAN_TYPE tRAN_TYPEField;
    ...
    public RouteOwnership Ownership
    {
    ...
    [XmlArrayItem("RouteId", IsNullable = false)]
    public string[] ParentRoutes
    {
      get => this.parentRoutesField;
      set => this.parentRoutesField = value;
    }

    public RouteTRAN_TYPE TRAN_TYPE
    {
