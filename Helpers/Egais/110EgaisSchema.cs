...
// Type: Gbs.Helpers.Egais.TTNIssueReturnFSMTypeHeader
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/TTNIssueReturnFSM")]
  [Serializable]
  public class TTNIssueReturnFSMTypeHeader
  {
