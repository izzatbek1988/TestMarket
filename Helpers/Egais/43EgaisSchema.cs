...
// Type: Gbs.Helpers.Egais.InvoiceIssueAMType
...
namespace Gbs.Helpers.Egais
{
  ...
  public class InvoiceIssueAMType
  {
    ...
    private InvoiceIssueAMTypeHeader headerField;
    private PositionInvoiceIssueAMType[] contentField;
    ...
    public InvoiceIssueAMTypeHeader Header
    {
    ...
    public PositionInvoiceIssueAMType[] Content
    {
