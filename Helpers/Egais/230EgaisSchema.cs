...
// Type: Gbs.Helpers.Egais.ActWriteOffShopType_v2
...
namespace Gbs.Helpers.Egais
{
  ...
  [Serializable]
  public class ActWriteOffShopType_v2
  {
    private string identityField;
    private ActWriteOffShopType_v2Header headerField;
    private ActWriteOffShopPositionType[] contentField;
    ...
    public ActWriteOffShopPositionType[] Content
    {
