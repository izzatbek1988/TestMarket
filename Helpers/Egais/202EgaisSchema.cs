...
// Type: Gbs.Helpers.Egais.WayBillType_v3Header
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/TTNSingle_v3")]
  [Serializable]
  public class WayBillType_v3Header
  {
    private WbType2 typeField;
    private string nUMBERField;
    private DateTime dateField;
    private DateTime shippingDateField;
    private TransportType2 transportField;
    ...
    public WayBillType_v3Header() => this.typeField = WbType2.WBInvoiceFromMe;
    ...
    public TransportType2 Transport
    {
