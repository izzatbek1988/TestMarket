...
// Type: Gbs.Helpers.Egais.ReturnNoticeFSMTypeHeader
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/ReturnNoticeFSM")]
  [Serializable]
  public class ReturnNoticeFSMTypeHeader
  {
    ...
    private string reasonReturnField;
    ...
    {
      get => this.reasonReturnField;
      set => this.reasonReturnField = value;
    }
  }
}
