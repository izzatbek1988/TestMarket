...
// Type: Gbs.Helpers.Egais.RequestAdjustmentData
...
namespace Gbs.Helpers.Egais
{
  ...
  [Serializable]
  public class RequestAdjustmentData
  {
    private string clientIdField;
    private string requestNumberField;
    private DateTime requestDateField;
    private RequestAdjustmentPositionType contentField;
    ...
    public RequestAdjustmentPositionType Content
    {
