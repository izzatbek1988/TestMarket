...
// Type: Gbs.Helpers.Egais.InvoiceIssueAMTypeHeader
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/InvoiceIssueAM")]
  [Serializable]
  public class InvoiceIssueAMTypeHeader
  {
    private string nUMBERField;
    private DateTime dateField;
    private OrgInfoRus_ClaimIssue importerField;
    private OrgInfoRus_ClaimIssue customsDepartmentField;
    private string requestAMField;
    ...
    public string RequestAM
    {
      get => this.requestAMField;
      set => this.requestAMField = value;
    }
