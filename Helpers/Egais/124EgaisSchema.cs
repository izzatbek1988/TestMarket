...
// Type: Gbs.Helpers.Egais.RequestRepealIAM
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(Namespace = "http://fsrar.ru/WEGAIS/RequestRepealIAM")]
  [Serializable]
  public class RequestRepealIAM
  {
    ...
    public string IAMRegId
    {
      get => this.iAMRegIdField;
      set => this.iAMRegIdField = value;
    }
  }
}
