...
// Type: Gbs.Helpers.Egais.CarrierNotice_v4Header
...
namespace Gbs.Helpers.Egais
{
  ...
  [XmlType(AnonymousType = true, Namespace = "http://fsrar.ru/WEGAIS/CarrierNotice_v4")]
  [Serializable]
  public class CarrierNotice_v4Header
  {
    ...
    private ClientTransportType clientTransportField;
    ...
    public ClientTransportType ClientTransport
    {
