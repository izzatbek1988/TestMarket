...
// Type: Gbs.Core.Devices.CheckPrinters.FiscalKkm.Models.AtolDrivers.WebRequests.PaymentMethodEnum
...
namespace Gbs.Core.Devices.CheckPrinters.FiscalKkm.Models.AtolDrivers.WebRequests
{
  public enum PaymentMethodEnum
  {
    ...
    [EnumMember(Value = "fullPayment")] FullPayment,
    [EnumMember(Value = "partialPayment")] PartialPayment,
    [EnumMember(Value = "credit")] Credit,
    [EnumMember(Value = "creditPayment")] CreditPayment,
  }
}
