...
// Type: Gbs.Core.Devices.Scales.Models.Rongta
...
{
  public class Rongta : IScale, IDevice
  {
    ...
    public Rongta(Gbs.Core.Config.Devices devConfig) => this.DevicesConfig = devConfig;
    ...
    public void Connect(bool onlyDriverLoad = false)
    {
      ...
      LogHelper.Debug(string.Format("Rongta COM-port: {0}, {1} / {2}", (object) this._port.PortName, (object) this._port.BaudRate, (object) this._port.ReadTimeout));
    ...
    public void GetWeight(out Decimal weight, Decimal price)
    {
      ...
      weight = str.Substring(1, 6).ToDecimal() / 1000.0M;
    }
